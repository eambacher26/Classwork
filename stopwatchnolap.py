...
from PyQt5.QtWidgets import QMainWindow, QPushButton, QLabel, QApplication, QLCDNumber
import sys
import datetime
...
class UI(QMainWindow):
    def __init__(self):
        ...
        self.view_lap_button.clicked.connect(self.viewLaps)
    ...
    def viewLaps(self):
        ...
        uic.loadUi("laptimes.ui", self.win)
        self.win.show()
